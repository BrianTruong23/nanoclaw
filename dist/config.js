...
export const CONTROL_PLANE_URL = process.env.CONTROL_PLANE_URL || envConfig.CONTROL_PLANE_URL;
export const AGENT_KEY = process.env.AGENT_KEY || envConfig.AGENT_KEY;
export const CONTROL_PLANE_POLL_INTERVAL_MS = Math.max(1000, parseInt(process.env.CONTROL_PLANE_POLL_INTERVAL_MS ||
    envConfig.CONTROL_PLANE_POLL_INTERVAL_MS ||
    '10000', 10) || 10000);
export const CONTROL_PLANE_HEARTBEAT_INTERVAL_MS = Math.max(1000, parseInt(process.env.CONTROL_PLANE_HEARTBEAT_INTERVAL_MS ||
    envConfig.CONTROL_PLANE_HEARTBEAT_INTERVAL_MS ||
    '30000', 10) || 30000);
export const CONTROL_PLANE_GROUP_FOLDER = process.env.CONTROL_PLANE_GROUP_FOLDER ||
    envConfig.CONTROL_PLANE_GROUP_FOLDER;
export const CONTROL_PLANE_CONTEXT_MODE = (process.env.CONTROL_PLANE_CONTEXT_MODE ||
    envConfig.CONTROL_PLANE_CONTEXT_MODE ||
    'group') === 'isolated'
    ? 'isolated'
    : 'group';
export const CONTROL_PLANE_INCLUDE_BACKLOG = (process.env.CONTROL_PLANE_INCLUDE_BACKLOG ||
    envConfig.CONTROL_PLANE_INCLUDE_BACKLOG ||
    'false').toLowerCase() === 'true';
export const CONTROL_PLANE_SUCCESS_STATUS = process.env.CONTROL_PLANE_SUCCESS_STATUS ||
    envConfig.CONTROL_PLANE_SUCCESS_STATUS ||
    'review';
export const CONTROL_PLANE_FAILURE_STATUS = process.env.CONTROL_PLANE_FAILURE_STATUS ||
